...
import { featuredSolutions, orderData, orderSaveMsg } from "../../support/data/order.data";
...
describe("Update a line item in the online store and Validate the entry in the console fulfilment", () => {
    ...
    it.skip("Verify the updated order entry in Console - Fulfillment page after updating the line item", () => {
        cy.wait(7000)
